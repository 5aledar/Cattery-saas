...
import img1 from "../assets/cats1.jpg";
  ...
  return (
    <>
      ...
      >
        ...
        <div className="w-full bg-slate-900 flex flex-row">
          <motion.div
            initial={{ x: -20, opacity: 0 }}
            animate={{ x: 0, opacity: 1 }}
            transition={{ duration: 1.5, delay: 0.5, ease: "easeInOut" }}
            className="w-1/2 flex items-center justify-center  bg-gray-800"
          >
            <div className="relative mx-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:px-8">
              <div className="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
                ...
                >
                  Cats intend to teach us that not everything in nature has a

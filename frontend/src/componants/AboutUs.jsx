                ...
                <div className="flex md:flex-row flex-col-reverse md:items-stretch items-center justify-center">
                    <div className="md:py-20 xl:w-1/2 sm:w-1/2 lg:mr-20 md:mr-6 flex flex-col md:items-end items-center justify-center xl:mr-28">
                        <div className="flex flex-col items-center justify-center">
                            <h1 className="md:text-5xl text-3xl font-bold text-center text-gray-300">WHAT IS OUR MISSION? </h1>
                            <p className="sm:w-96 w-full mt-6 text-base leading-6 text-center text-gray-400">At Cattery Saas, we’re here to give you the knowledge you need to give your cat the best life possible.</p>
                            <div className="md:mt-14 mt-12 flex flex-col items-center">
                                ...
                                <p className="text-base leading-6 mt-6 text-center text-gray-400 sm:w-96 w-full">Our team is 100% cat-obsessed, and we’re dedicated to providing safe, reputable information that keeps cats happy and healthy.</p>
                            </div>
                            <div className="mt-7 flex flex-col items-center">
                                ...
                                <p className="text-base leading-6 mt-6 text-center text-gray-400 sm:w-96 w-full">We’re here to get you the facts with no fluff—that way, you can spend less time researching and more time with your cat.</p>
                            </div>
                            <div className="mt-7 flex flex-col items-center">
                                ...
                                <p className="text-base leading-6 mt-6 text-center text-gray-400 sm:w-96 w-full">We buy all of our own products for review and test them with real cats.</p>
                            </div>
                            <div className="mt-7 flex flex-col items-center">
                                ...
                                <p className="text-base leading-6 mt-6 text-center text-gray-400 sm:w-96 w-full">When you want answers about your cat’s health, trustworthy information is vital</p>
                            </div>
                        </div>
                    </div>
